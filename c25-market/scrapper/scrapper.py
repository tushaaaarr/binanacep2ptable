    ...
    def scrap(self,link,index,pages)-> None:
        ...
        for _ in range(pages):
            ...
            for element in elements:
                ...
                doc = {"exchange": "Binance","advertiser_no" : advertiser_no, "advertiser":advertiser,"orders":orders,"completion":completion,"price":price,"fiat":fiat,"payment":payment_methods,"available":available,"limit":limit}
